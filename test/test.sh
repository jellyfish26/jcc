...
compile() {
  gcc -E -P -C $1 > $1.tmp
  ../jcc $1.tmp $1.s
  gcc -no-pie -g -o tmp $2 common.o $1.s
  rm $1.s $1.tmp
}

compile_only_jcc() {
  ../jcc $1.c $1.s
  gcc -no-pie -g -o tmp common.o $1.s
  rm $1.s
}

# Check hashmap
gcc -std=c11 -c -o common.o common_gcc.c
gcc -std=c11 -c -o hashmap.o hashmap_gcc.c -I ../src

gcc -no-pie -g -o tmp ../src/util/hashmap.o hashmap.o
check "hashmap.c"

# Check function ABI
gcc -std=c11 -c -o function_abi_gcc.o function_abi_gcc.c
